...
/**
 * Fábrica concreta encargada de instanciar objetos de la clase
 * {@link Agricultura}. Implementa la interfaz {@link DronFactory}.
 *
...
public class AgriculturaFactory implements DronFactory {
	 ...
	 */
	public AgriculturaFactory(int id, String serial, String modelo, String fabricante, int peso,
	 ...
	 *
	 * @return Instancia concreta de {@link Agricultura} configurada como un
	 *         {@link Dron}.
	 */
	@Override
